...
public class Birdy extends ApplicationAdapter {
	SpriteBatch batch;
	Texture background;
	Texture bird;
	Texture bee1;
	...
	public void create () {
		...
		bee1 = new Texture("enemy1.png");
		bee2 = new Texture("enemy1.png");
		bee3 = new Texture("enemy1.png");
	...
	@Override
	public void render () {
		//Sürekli çağrılan yer animasyonlar vs burada kodlanır
